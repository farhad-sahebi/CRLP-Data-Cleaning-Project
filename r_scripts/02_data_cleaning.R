...
tool1_crlp <- read_excel(
  "C:/Users/Dell/Desktop/Portfolio Projects/R Projects/1st_ CRLP Project/CRLP Tool 1 CDC Member List Aanalysis/Tool1_CDC_Members List_12324.xlsx"
)
# Quick look
head(tool1_crlp)
